...
class ProductList(models.AbstractModel):
    _name = 'report.report_test_stock_forecast_customer.report_customer'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        for product in data:
            products_grouped[(product['car_number'], product['productname'], product['custname'])] = {
                'productname': product['productname'],
                'custname': product['custname'],
                'car_num': product['custname'],
